...
public class AppConjunto {
    ...
    public boolean sonIguales(PilaTDA pila, ConjuntoTDA conjunto) {
        ...
        if (obtenerTamanioPila(pila) != obtenerTamanioConjunto(conjunto)) {
            return false;
        }
    ...
    private int obtenerTamanioPila(PilaTDA pila) {
    ...
    private int obtenerTamanioConjunto(ConjuntoTDA conjunto) {
